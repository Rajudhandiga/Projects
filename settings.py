"""
Django settings for sentiment_lexicon project.
...
ROOT_URLCONF = 'User_Behavior_Prediction.urls'
...
WSGI_APPLICATION = 'User_Behavior_Prediction.wsgi.application'
