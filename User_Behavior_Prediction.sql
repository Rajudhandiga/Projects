...
--
-- Host: localhost
-- Generation Time: Dec 15, 2020 at 01:19 PM
...
--
-- Database: `user_behavior_prediction`
--
CREATE DATABASE IF NOT EXISTS `user_behavior_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `user_behavior_prediction`;
...
('2t9bnxor9bvkdkg7jik9pfdjgh9ds61y', 'OWIzMzUzMjM4ZjQxYjFkZDY5MWRlNmViNjdiMzgwNTU2NjYzZTAxYjp7InVzZXJpZCI6Nn0=', '2020-12-29 13:12:52.767578'),
...
(4, 'Ravi', 'Ravi123@gmail.com', 'Ravi', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(5, 'Raju', 'Raju123@gmail.com', 'Raju', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(6, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(7, 'Gopi', 'Gopi123@gmail.com', 'Gopi', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(8, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnatka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_productdetails_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_productdetails_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
